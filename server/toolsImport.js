...
const url = 'https://sephora.p.rapidapi.com/us/products/v2/list?categoryId=cat130042&pageSize=60&currentPage=1'
const options = {
...
const toolsImport = async () => {
  const client = new MongoClient(MONGO_URI, options);
    ...
    const result = await db.collection("tools").insertMany(documents);
