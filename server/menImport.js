...
const url = 'https://sephora.p.rapidapi.com/us/products/v2/list?categoryId=cat130044&pageSize=60&currentPage=1';
const option = {
    method: 'GET',
      headers: {
...
const skinImport = async () => {
  const client = new MongoClient(MONGO_URI, options);
    ...
    const result = await db.collection("men").insertMany(documents);
